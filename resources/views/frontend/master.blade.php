...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('/')}}front/assets/favicon.png">
    ...
    <link rel="stylesheet" href="{{asset('/')}}front/assets/https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
