...
@section('body')
    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('/')}}front/assets/images/hero_5.jpg');">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="post-entry text-center">
                        ...
                        <div class="post-meta align-items-center text-center">
                            <figure class="author-figure mb-0 me-3 d-inline-block"><img src="{{asset('/')}}front/assets/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="post-content-body">
                        ...
                        <div class="row my-4">
                            <div class="col-md-12 mb-4">
                                <img src="{{asset('/')}}front/assets/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('/')}}front/assets/images/img_2_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('/')}}front/assets/images/img_3_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                        </div>
                    ...
                    <div class="pt-5 comment-wrap">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="vcard">
                                    <img src="{{asset('/')}}front/assets/images/person_1.jpg" alt="Image placeholder">
                                </div>
                            ...
                            <li class="comment">
                                <div class="vcard">
                                    <img src="{{asset('/')}}front/assets/images/person_2.jpg" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                    <h3>Jean Doe</h3>
                                    <div class="meta">January 9, 2018 at 2:21pm</div>
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard">
                                            <img src="{{asset('/')}}front/assets/images/person_3.jpg" alt="Image placeholder">
                                        </div>
                                        <div class="comment-body">
                                            <h3>Jean Doe</h3>
                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <div class="vcard">
                                                    <img src="{{asset('/')}}front/assets/images/person_4.jpg" alt="Image placeholder">
                                                </div>
                                                <div class="comment-body">
                                                    <h3>Jean Doe</h3>
                                                    <div class="meta">January 9, 2018 at 2:21pm</div>
                                                ...
                                                <ul class="children">
                                                    <li class="comment">
                                                        <div class="vcard">
                                                            <img src="{{asset('/')}}front/assets/images/person_5.jpg" alt="Image placeholder">
                                                        </div>
                                                        <div class="comment-body">
                                                            <h3>Jean Doe</h3>
                                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            <img src="{{asset('/')}}front/assets/images/person_2.jpg" alt="Image Placeholder" class="img-fluid mb-3">
                            <div class="bio-body">
                    ...
                    <div class="sidebar-box">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                <li>
                                    <a href="">
                                        <img src="{{asset('/')}}front/assets/images/img_1_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                ...
                                <li>
                                    <a href="">
                                        <img src="{{asset('/')}}front/assets/images/img_2_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">March 15, 2018 </span>
                                ...
                                <li>
                                    <a href="">
                                        <img src="{{asset('/')}}front/assets/images/img_3_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">March 15, 2018 </span>
